...
app = Flask(__name__)
slack_event_adapter = SlackEventAdapter('714770507e48d3d186c4c2a0b0ca66cd', "/slack/events", app)

client = slack.WebClient(token="xoxb-5061100866689-5033962480439-rw7LmBbqYwkTZxALULC7NoLV")
